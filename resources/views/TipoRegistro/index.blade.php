                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header">Tipo Registro
                                ...
                                <div class="table-responsive">
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th class="text-center">IdTipoRegistro</th>
                                                <th class="text-center">GlosaTipoRegistro
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center text-muted">{{$list->IdTipoRegistro}}</td>
